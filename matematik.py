...
# --- GENİŞLETİLMİŞ SİTE HAVUZU (Hiçbir şey silinmedi) ---
siteler_havuzu = [
    ...
    {"isim": "Sinan Sarıtaş", "aciklama": "Eğlenceli oyunlar, PDF çalışma kağıtları ve etkinlikler (Ana sayfada ara)", "strategy": "native", "search_url": "https://sinansaritas.com/", "kategori": "game", "kaynak": "Sinan Sarıtaş"},
    ...
    {"isim": "Liveworksheets", "aciklama": "Etkileşimli çalışma yaprakları (Ana sayfada Türkçe arama yap)", "strategy": "native", "search_url": "https://www.liveworksheets.com/", "kategori": "interaktif", "kaynak": "Global"},
...
# --- TABS (Oyunlar Sekmesi Eklendi) ---
tab1, tab_oyun, tab2, tab3 = st.tabs(["🚀 Aktif Eğitim Kanalları Matrisi", "🎮 Sadece Oyunlar", "❤️ Favorilerim", "📊 Kurumsal Entegrasyon Şeması"])
...
with tab_oyun:   # 🎮 Sadece Oyunlar Sekmesi
    ...
    if not oyunlar:
        st.info("Bu filtrede oyun bulunamadı. Farklı bir konu seçin.")
    else:
        col_left, col_right = st.columns(2)
